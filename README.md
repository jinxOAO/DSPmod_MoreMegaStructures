...
<!--## Nicoll-Dyson Beam (Star Cannon) Currently unavailable

- This megastructure won't be available unless you have installed the mod [TheyComeFromVoid](https://dsp.thunderstore.io/package/ckcz123/TheyComeFromVoid/) , which version must be at least 2.0.0.   
