...
namespace MoreMegaStructure
{
    internal static class MMSProtos
    {
        ...
        public static void AddTranslateProtoNames4()
        {
            ...
            LocalizationModule.RegisterTranslation(
                "水滴描述gm",
                "Droplets can fight as Icarus' space fleet. It uses extremely solid surface to hit key structures. Precise control of the droplet's propulsion and steering requires powerful remote computing power, as well as a remote supply of Mecha energy to control it. If the launch them manually, they will use 10 times as much energy to attack all enemies in the entire star system, not just those within 1 AU. Although the damage efficiency of the droplet is limited by its attack mode, its structure of strongly interacting materials allows it to withstand unlimited damage. You neet to set the space fleet type to droplet type to use the droplet.",
                "水滴可以作为伊卡洛斯的空中舰队进行作战，并使用极其坚硬的表面撞击敌人的关键结构。精确地控制水滴的推进和转向需要强大的远端运算能力，且发射水滴和操控也需要机甲能量的远程供给。如果主动发射水滴，其还可以消耗10倍的能量来攻击整个星系内的敌人，而不仅仅是1AU以内的敌人。虽然水滴的输出效率受其攻击方式限制，但其由强相互作用力材料组成的结构可以使其承受无限的伤害。你需要将太空编队的类型设置为水滴编队，以此放入水滴。", "");
            ...
            LocalizationModule.RegisterTranslation("目标无法定位警告", "Unable to locate any targets! Please check that you've visited that star system before, and that star system has surviving DF hive.", "无法定位任何目标！请确认至少进入过该星系一次，且该星系有存活的黑雾巢穴。", "");
            ...
            LocalizationModule.RegisterTranslation("警告巨构不支持恒星系数量大于1200个",
                                                   "Warning! This MegaStructure does not support the galaxy with more than 1200 star systems.  Please find another star system with StarIndex lower than 1200",
                                                   "警告！此巨构不支持恒星系数量大于1200个！请寻找一个序号小于1200的恒星系。", "");
            ...
            LocalizationModule.RegisterTranslation("特化2介绍内容", "Requirements: At least 3 <color=#30bb30>Chemical</color>, <color=#30bb30>Petroleum</color> or <color=#30bb30>Production Enhancer</color> recipes are assigned, and no other types of recipes assigned.\n\nSpecialized effect: raw materials and products for all <color=#30bb30>chemical</color>, <color=#30bb30>petroleum</color> and <color=#30bb30>proliferator</color> recipes will be automatically <color=#61d8ffc0>sprayed with proliferator for free</color>, and have <color=#61d8ffc0>extra-output-enabled</color>, besides, their <color=#61d8ffc0>production speed +100%</color>.\n\n<color=#61d8ffc0>Extra-output-enabled</color>: After all raw materials of the recipe are sprayed with proliferators, this recipe will definitely gain the <color=#61d8ffc0>extra product</color> effect in the Interstellar Assembly, regardless of whether the recipe prohibits extra output effects. ",
                                                   ...
                                                   "");
            LocalizationModule.RegisterTranslation("特化3介绍内容", "Requirements: At least 3 recipes <color=#30bb30><i>containing</i></color> <color=#30bb30>Antimatter</color> or <color=#30bb30>Deuterium</color> are assigned, and no other types of recipes assigned. \n\nSpecialization effects: All recipes <color=#30bb30><i>containing</i></color> <color=#30bb30>antimatter</color> or <color=#30bb30>deuterium</color> have <color=#61d8ffc0>extra-output-enabled</color> and gain <color=#61d8ffc0>+25% additional output</color>. \n\n<color=#30bb30><i>Containing</i></color> : The recipe requires specifying item as raw material inputs, or one of the products is that item.\n\n<color=#61d8ffc0>Extra-output-enabled</color>: After all raw materials of the recipe are sprayed with proliferators, this recipe will definitely gain the <color=#61d8ffc0>extra product</color> effect in the Interstellar Assembly, regardless of whether the recipe prohibits extra output effects.",
                                                   "要求：分配了至少3个<color=#30bb30><i>包含</i></color><color=#30bb30>反物质</color>或<color=#30bb30>重氢</color>的配方，且没有不<color=#30bb30><i>包含</i></color>的配方。\n\n特化效果：所有<color=#30bb30><i>包含</i></color><color=#30bb30>反物质</color>或<color=#30bb30>重氢</color>的配方<color=#61d8ffc0>允许增产</color>，并获得<color=#61d8ffc0>+25%额外产出</color>。\n\n<color=#30bb30><i>包含</i></color>：配方需要指定物品作为原材料输入，或者产物之一指定物品。\n\n<color=#61d8ffc0>允许增产</color>：配方的原料喷涂增产剂后，在星际组装厂中生产的产物一定可以获得<color=#61d8ffc0>额外产出</color>效果，无论该配方是否禁止额外产出效果。",
                                                   "");
            LocalizationModule.RegisterTranslation("特化4介绍内容", "Requirements: At least 5 recipes <color=#30bb30><i>containing</i></color> <color=#30bb30>processor</color>, <color=#30bb30>quantum chip</color> or <color=#30bb30>quantum computer</color> are assigned, and no other types of recipes assigned.\n\nSpecialized effects: All recipes that <color=#30bb30>use processors</color>, <color=#30bb30>quantum chips</color> or <color=#30bb30>quantum computers</color> as inputs have <color=#61d8ffc0>extra-output-enabled</color>, and gain <color=#61d8ffc0>+25% additional output</color>; \n<color=#30bb30>Production processor</color>, <color=#30bb30>Quantum chip</color> and <color=#30bb30>Quantum Computer</color>'s recipe itself will gain <color=#61d8ffc0>+50% additional output</color> instead.\n\n<color=#30bb30><i>Containing</i></color> : The recipe requires specifying item as raw material inputs, or one of the products is that item.\n\n<color=#61d8ffc0>Extra-output-enabled</color>: After all raw materials of the recipe are sprayed with proliferators, this recipe will definitely gain the <color=#61d8ffc0>extra product</color> effect in the Interstellar Assembly, regardless of whether the recipe prohibits extra output effects.",
                                                   "要求：分配了至少5个<color=#30bb30><i>包含</i></color><color=#30bb30>处理器</color>或<color=#30bb30>量子芯片</color>或<color=#30bb30>量子计算机</color>的配方，且没有不<color=#30bb30><i>包含</i></color>的配方\n\n特化效果：所有<color=#30bb30>使用处理器</color>、<color=#30bb30>量子芯片</color>、<color=#30bb30>量子计算机</color>作为输入的配方<color=#61d8ffc0>允许增产</color>，并获得<color=#61d8ffc0>+25%额外产出</color>；\n<color=#30bb30>生产处理器</color>、<color=#30bb30>量子芯片</color>、<color=#30bb30>量子计算机</color>的配方则转而<color=#61d8ffc0>+50%额外产出</color>。\n\n<color=#30bb30><i>包含</i></color>：配方需要指定物品作为原材料输入，或者产物之一指定物品。\n\n<color=#61d8ffc0>允许增产</color>：配方的原料喷涂增产剂后，在星际组装厂中生产的产物一定可以获得<color=#61d8ffc0>额外产出</color>效果，无论该配方是否禁止额外产出效果。",
                                                   "");
            LocalizationModule.RegisterTranslation("特化5介绍内容", "Requirements: At least 5 recipes that produce <color=#30bb30>combat drones</color>, <color=#30bb30>warships</color>, <color=#30bb30>ammo</color> or <color=#30bb30>defense facilities</color> are assigned, and no other types of recipes assigned.\n\nSpecialized effects: All recipes of <color=#30bb30>attack drones</color>, <color=#30bb30>warships</color> and <color=#30bb30>defense facilities</color> have <color=#61d8ffc0>extra-output-enabled</color> and gain <color=#61d8ffc0>+50% additional output</color>; the recipes of <color=#30bb30>ammo</color> gain <color=#61d8ffc0>+100% additional output</color> instead.\n\n<color=#61d8ffc0>Extra-output-enabled</color>: After all raw materials of the recipe are sprayed with proliferators, this recipe will definitely gain the <color=#61d8ffc0>extra product</color> effect in the Interstellar Assembly, regardless of whether the recipe prohibits extra output effects.",
